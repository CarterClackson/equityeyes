...
const HomePage = () => {
    ...
    <React.Fragment>
        <Nav />
        <section className="bg-section bg-cover bg-center h-full relative">
            <div className="inset-0 bg-black-50 text-white p-4 pt-44 flex flex-col justify-center items-center h-full">
                ...
                <LoginForm loadText='Please wait...' isSignup={true} />
            </div>
        </section>
    </React.Fragment>
    );
